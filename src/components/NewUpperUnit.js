...
const NewUpperUnit = (props) => {
  const [selectedParentOrganisationUnit, setSelectedParentOrganisationUnit] =
    useState(null);
  ...
  const insertNewUpperUnit = async () => {
    ...
    await props.actionAddNewUpperUnit(
        ...
        <Row>
          <Col md="4">
            <OrganisationUnitSearch
              onOrganisationUnitChange={organisationUnitSelection}
              selectedParentOrganisationUnit={selectedParentOrganisationUnit}
            />
          </Col>
          <Col md="2">
            <HierarchyDropDown
              onHierarchyChange={hierarchySelection}
              hierarchySelection={selectedHierarchy}
            />
          </Col>
          <Col md="2">
            <PickDate
